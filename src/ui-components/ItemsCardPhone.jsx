...
export default function ItemsCardPhone(props) {
  const { phoneride, overrides, ...rest } = props;
  const vectorFourOneFourSixSixNineFiveOnClick = useDataStoreDeleteAction({
    id: phoneride?.id,
    model: Rides,
    schema: schema,
  });
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "ItemsCardPhone")}
      {...rest}
    >
      <Image
        width="unset"
      ...
      >
        ...
        >
          <Text
            ...
            top="0%"
            bottom="76.19%"
            left="calc(50% - 144px - 0px)"
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${"Rs. "}${phoneride?.price_per_seat}${" per seat"}`}
            {...getOverrideProps(overrides, "Rs. 99")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children={`${"Contact: "}${phoneride?.phone}`}
          {...getOverrideProps(overrides, "Contact for Ride:")}
        ></Text>
        <Flex
          gap="5px"
          direction="row"
        ...
        >
          ...
          >
            <Icon
              width="20px"
              height="18.42px"
              viewBox={{ minX: 0, minY: 0, width: 20, height: 18.421142578125 }}
              paths={[
                {
              ...
              left="0%"
              right="0%"
              {...getOverrideProps(overrides, "Vector4146693")}
            ></Icon>
          </View>
          <View
            width="24px"
          ...
          >
            <Icon
              ...
              right="20.83%"
              onClick={() => {
                vectorFourOneFourSixSixNineFiveOnClick();
              }}
              {...getOverrideProps(overrides, "Vector4146695")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
