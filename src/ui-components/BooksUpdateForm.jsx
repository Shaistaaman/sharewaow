...
export default function BooksUpdateForm(props) {
  ...
  React.useEffect(() => {
    const queryData = async () => {
      ...
      const UsersBooksRecord = record ? await record.UsersBooks : undefined;
      setUsersBooks(UsersBooksRecord);
    };
    queryData();
  }, [idProp, booksModelProp]);
  React.useEffect(resetStateValues, [booksRecord, UsersBooks]);
        ...
        try {
          ...
          await DataStore.save(
            Books.copyOf(booksRecord, (updated) => {
              ...
              if (!modelFields.UsersBooks) {
                updated.booksUsersBooksId = undefined;
              }
            })
          );
          if (onSuccess) {
