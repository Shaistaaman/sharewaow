...
export default function FoodsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setUsersFoods(initialValues.UsersFoods);
    setCurrentUsersFoodsValue(undefined);
    setCurrentUsersFoodsDisplayValue("");
    setExpire_foods(initialValues.expire_foods);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "FoodsCreateForm")}
      {...rest}
    >
      <TextField
        label="Image"
